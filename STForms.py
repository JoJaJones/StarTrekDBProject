...
class CharacterForm(FlaskForm):
    ...
    sixth_field = SelectMultipleField("Species: ", validate_choice=False, validators=[validators.Optional()])
    seventh_field = SelectMultipleField("Affiliations: ", validate_choice=False, validators=[validators.Optional()])
